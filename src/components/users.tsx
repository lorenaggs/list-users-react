    ...
    return (
        <div className="min-h-screen pb-12">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 mb-10 fade-in">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-8 mb-10">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                            <div
                                className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center shadow-md">
                                <FontAwesomeIcon icon={faUser} className="text-green-600 text-3xl"/>
                            </div>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                <h1 className="text-4xl lg:text-5xl font-bold text-gray-800 uppercase">Lista de
                                    Usuarios</h1>
                                <span
                                    className="bg-gray-100 text-gray-600 px-5 py-2.5 rounded-full text-base font-medium">
                    ...
                    {user.length === 0 ? (
                        ...
                        <>
                            {selectedUsers.size > 0 && (
                                <div
                                    className="mb-6 p-4 bg-red-50 border-2 border-red-200 rounded-xl flex flex-col sm:flex-row items-center justify-between gap-4">
                                    ...
                                    {user.map((userItem) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-3">
                                                    <span
                                                        className="inline-block px-5 py-2.5 rounded-full text-base font-medium bg-blue-100 text-blue-800 capitalize">
                                                        {userItem.gender}
                                                    </span>
                                            </td>
                                            <td className="px-6 py-3">
                                                    <span
                                                        className={`inline-block px-5 py-2.5 rounded-full text-base font-medium border capitalize ${getStatusBadgeClass(userItem.status)}`}>
                                                        {userItem.status}
                                                    </span>
                                            </td>
                                            <td className="px-6 py-3">
            ...
            {showForm && (
                ...
                >
                    <div
                        className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto slide-in relative">
                        <button
